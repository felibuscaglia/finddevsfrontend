    ...
    return (
        <div id={style.mainDiv} style={{ background: project.mainColor, color: project.brightness === 'bright' ? '#fff' : '#000' }}>
            ...
            <div id={style.btnDiv}>
                ...
                <a className="links" href={project.workZone} target='_blank' rel="noreferrer"><div style={{ color: project.brightness === 'bright' ? '#fff' : '#000', border: project.brightness === 'bright' ? '2px solid #fff' : '2px solid #000' }} className={style.redirectDiv}><span><FontAwesomeIcon icon={faTerminal} /> Work Zone</span></div></a>
